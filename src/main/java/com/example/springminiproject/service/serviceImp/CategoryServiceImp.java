...
public class CategoryServiceImp implements CategoryService {
    ...
    @Override
    public CategoryDTO insertNewCategory(CategoryRequest categoryRequest) {
    ...
    @Override
    public List<CategoryDTO> getAllCategories(int pageNo, int pageSize, String sortBy, String sortDirection) {
    ...
    public CategoryDTO getCategoryByCategoryId(Long id) {
        return categoryRepository.findById(id).map(Category::categoryDTOResponse).orElseThrow();
    }
    ...
    @Override
    public void updateCategoryByCategoryId(Long id, CategoryRequest categoryRequest) {
        categoryRepository.updateCategoryByCategoryId(id, categoryRequest.getCategoryName());
    }
}
